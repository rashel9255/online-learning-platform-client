...
const HeaderDashboard = () => {
    ...
    const navLinks = (
        <>
            <li>
                <NavLink to="/dashboard" end className={({ isActive }) => (isActive ? "text-blue-600 font-bold border-b-2 border-blue-600 pb-1" : "hover:text-primary")}>
                    My Courses
                </NavLink>
            </li>
            <li>
                <NavLink to="/dashboard/my-added-course" className={({ isActive }) => (isActive ? "text-blue-600 font-bold border-b-2 border-blue-600 pb-1" : "hover:text-primary")}>
                    My Added Course
                </NavLink>
            </li>
            <li>
                <NavLink to="/dashboard/add-course" className={({ isActive }) => (isActive ? "text-blue-600 font-bold border-b-2 border-blue-600 pb-1" : "hover:text-primary")}>
                    Add Course
                </NavLink>
            </li>
        </>
